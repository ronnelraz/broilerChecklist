...
public class model_edit_list {
    ...
    public model_edit_list(int id, String audit_date, String farm_name, String house_flock, String broiler_count, String broiler_wgh, String broiler_reject_count, String broiler_reject_wgh, boolean auto_count) {
        this.id = id;
