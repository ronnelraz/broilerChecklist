...
public class Adapter_cancel_checklist extends RecyclerView.Adapter<Adapter_cancel_checklist.ViewHolder>  {
    Context mContext;
    ...
    public Adapter_cancel_checklist(List<model_confirm_list> list, Context context, Func func, Cancel_menu cancelMenu) {
        super();
        this.newsList = list;
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (getData.isChecked()) {
                    ...
                    cancelMenu.confirm.show();
                    int color = Color.parseColor("#F2F6F2");
                    holder.card.setBackgroundTintList(ColorStateList.valueOf(color));
                }
                if (selectedItems.isEmpty()) {
                    cancelMenu.confirm.hide();
                }
